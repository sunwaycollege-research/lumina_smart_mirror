...
*(Note: Project is transitioning from Lumina to the SOMA framework).*
...
* **Sensors:** Ultrasonic Distance Sensors, PIR Motion Detectors, and a High-Definition Camera Module
...
git clone [https://github.com/dawgybey/lumina.git](https://github.com/dawgybey/lumina.git)
cd lumina
